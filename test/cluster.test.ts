...
describe('Cluster Util', () => {
  ...
  it('devnet', () => {
    expect(clusterApiUrl()).to.eq('https://api.devnet.solvia.io');
    expect(clusterApiUrl('devnet')).to.eq('https://api.devnet.solvia.io');
    expect(clusterApiUrl('devnet', true)).to.eq(
      'https://api.devnet.solvia.io',
    );
    expect(clusterApiUrl('devnet', false)).to.eq(
      'http://api.devnet.solvia.io',
    );
  });
});
